...
public class DatabasePartiesTest {
    ...
    public void testAddParty_New() throws Exception {
        ...
        party.setName("noobs");
        party.setMembers(Sets.newHashSet(new Member(LEISER_USER, Rank.MEMBER), new Member(TestDatabase.VINCENT_USER, Rank.OWNER), new Member(TestDatabase.SK_USER, Rank.MEMBER)));
        party.setCreateTime(TestDatabase.parseDate("2012-01-02 11:12:13"));

        Party addedParty = partyManager.findPartyByName("noobs");
        assertThat(party.getName(), equalTo("noobs"));
        assertThat(party.getCreateTime(), equalTo(TestDatabase.parseDate("2012-01-02 11:12:13")));

        assertThat(party.getMembers().size(), is(3));
        assertThat(party.getMembers(), containsInAnyOrder(new Member(TestDatabase.VINCENT_USER, Rank.OWNER), new Member(LEISER_USER, Rank.MEMBER), new Member(TestDatabase.SK_USER, Rank.MEMBER)));
    }
    ...
    public void testFindPartiesByName() throws Exception {
        ...
        assertThat(parties.get("guests").getCreateTime(), equalTo(TestDatabase.parseDate("2015-03-05 10:20:30")));
        assertThat(parties.get("friends").getCreateTime(), equalTo(TestDatabase.parseDate("2015-02-04 10:20:30")));
    }
    ...
    public void testFindPartyByName() throws Exception {
        ...
        assertThat(party.getMembers().size(), is(2));
        assertThat(party.getMembers(), containsInAnyOrder(new Member(TestDatabase.VINCENT_USER, Rank.OWNER), new Member(TestDatabase.SK_USER, Rank.MEMBER)));
    }
    ...
    public void testRefreshParty() throws Exception {
        ...
        assertThat(partyManager.findPartyByName("guests").getCreateTime(), equalTo(TestDatabase.parseDate("2015-03-05 10:20:30")));
    }
    ...
    public void testAddMembers() throws Exception {
        ...
        partyManager.addMembers("friends", Sets.newHashSet(new Member(TestDatabase.VINCENT_USER, Rank.MEMBER)));
        partyManager.refreshParty(party);

        assertThat(party.getMembers().size(), is(2));
        assertThat(party.getMembers(), containsInAnyOrder(
                new Member(TestDatabase.VINCENT_USER, Rank.OWNER),
                new Member(TestDatabase.SK_USER, Rank.MEMBER)
        ));
    }
    ...
    public void testRemoveMembers() throws Exception {
        ...
        partyManager.removeMembers("guests", Sets.newHashSet(TestDatabase.SK_USER));
        partyManager.refreshParty(party);
