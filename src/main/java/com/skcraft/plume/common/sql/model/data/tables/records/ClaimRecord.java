...
public class ClaimRecord extends UpdatableRecordImpl<ClaimRecord> implements Record7<String, String, Integer, Integer, Integer, String, Date> {

	private static final long serialVersionUID = 1300752318;
	 ...
	 */
	@Override
	public Row7<String, String, Integer, Integer, Integer, String, Date> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<String, String, Integer, Integer, Integer, String, Date> valuesRow() {
	 ...
	 */
	@Override
	public ClaimRecord value7(Date value) {
		setIssueTime(value);
		return this;
	}
	 ...
	 */
	@Override
	public ClaimRecord values(String value1, String value2, Integer value3, Integer value4, Integer value5, String value6, Date value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ClaimRecord(String server, String world, Integer x, Integer z, Integer ownerId, String partyName, Date issueTime) {
		super(Claim.CLAIM);
