 ...
 */
package com.skcraft.plume.common.sql.model.data;


import com.skcraft.plume.common.sql.model.data.tables.Ban;
import com.skcraft.plume.common.sql.model.data.tables.Claim;
import com.skcraft.plume.common.sql.model.data.tables.Group;
import com.skcraft.plume.common.sql.model.data.tables.GroupParent;
import com.skcraft.plume.common.sql.model.data.tables.Party;
import com.skcraft.plume.common.sql.model.data.tables.PartyMember;
import com.skcraft.plume.common.sql.model.data.tables.User;
...
import com.skcraft.plume.common.sql.model.data.tables.records.PartyMemberRecord;
import com.skcraft.plume.common.sql.model.data.tables.records.PartyRecord;
import com.skcraft.plume.common.sql.model.data.tables.records.UserGroupRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<BanRecord, UserIdRecord> FK_BAN_USER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, Ban.BAN, Ban.BAN.USER_ID);
		public static final ForeignKey<BanRecord, UserIdRecord> FK_BAN_ISSUE_BY = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, Ban.BAN, Ban.BAN.ISSUE_BY);
		public static final ForeignKey<BanRecord, UserIdRecord> FK_BAN_PARDON_BY = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, Ban.BAN, Ban.BAN.PARDON_BY);
		public static final ForeignKey<ClaimRecord, UserIdRecord> FK_CLAIM_OWNER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, Claim.CLAIM, Claim.CLAIM.OWNER_ID);
		public static final ForeignKey<ClaimRecord, PartyRecord> FK_CLAIM_PARTY_NAME = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_PARTY_PRIMARY, Claim.CLAIM, Claim.CLAIM.PARTY_NAME);
		public static final ForeignKey<GroupParentRecord, GroupRecord> FK_GROUP_PARENT_PARENT_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_GROUP_PRIMARY, GroupParent.GROUP_PARENT, GroupParent.GROUP_PARENT.PARENT_ID);
		public static final ForeignKey<GroupParentRecord, GroupRecord> FK_GROUP_PARENT_GROUP_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_GROUP_PRIMARY, GroupParent.GROUP_PARENT, GroupParent.GROUP_PARENT.GROUP_ID);
		public static final ForeignKey<PartyMemberRecord, PartyRecord> FK_PARTY_MEMBER_PARTY_NAME = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_PARTY_PRIMARY, PartyMember.PARTY_MEMBER, PartyMember.PARTY_MEMBER.PARTY_NAME);
		public static final ForeignKey<PartyMemberRecord, UserIdRecord> FK_PARTY_MEMBER_USER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, PartyMember.PARTY_MEMBER, PartyMember.PARTY_MEMBER.USER_ID);
		public static final ForeignKey<UserRecord, UserIdRecord> FK_USER_USER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, User.USER, User.USER.USER_ID);
		public static final ForeignKey<UserRecord, UserIdRecord> FK_USER_REFERRER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, User.USER, User.USER.REFERRER_ID);
		public static final ForeignKey<UserGroupRecord, UserIdRecord> FK_USER_GROUP_USER_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_USER_ID_PRIMARY, UserGroup.USER_GROUP, UserGroup.USER_GROUP.USER_ID);
		public static final ForeignKey<UserGroupRecord, GroupRecord> FK_USER_GROUP_GROUP_ID = createForeignKey(com.skcraft.plume.common.sql.model.data.Keys.KEY_GROUP_PRIMARY, UserGroup.USER_GROUP, UserGroup.USER_GROUP.GROUP_ID);
	}
}
