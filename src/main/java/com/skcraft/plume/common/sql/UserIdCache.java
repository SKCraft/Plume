...
import com.skcraft.plume.common.sql.model.data.tables.records.UserIdRecord;
...
public class UserIdCache {
     ...
     */
    @Nullable
    public UserId fromRecord(Record record, com.skcraft.plume.common.sql.model.data.tables.UserId table) {
