 ...
 */
package com.skcraft.plume.common.sql.model.log.tables;


import com.skcraft.plume.common.sql.model.log.Keys;
...
public class Log extends TableImpl<LogRecord> {
	...
	private static final long serialVersionUID = 981647071;
	...
	private Log(String alias, Table<LogRecord> aliased, Field<?>[] parameters) {
		super(alias, com.skcraft.plume.common.sql.model.log.Log.LOG, aliased, parameters, "");
	}
